  ...
  return (
    ...
    <div className="max-w-4xl mx-auto p-6">
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-600 mb-6">Last updated: March 10, 2025</p>
        <p className="mb-4">
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-6 space-y-2 mb-4">
          ...
          <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Next Learn Technologies, Mailer Jobs No.182, 1st Floor, 2nd Main, K G Layout, New BEL Road, Bengaluru - 560094.</li>
          ...
          <li><strong>Website</strong> refers to Mailer Jobs, accessible from https://mailerjobs.com/</li>
      ...
      <section className="mb-8">
        ...
        <div className="mb-4">
          <h4 className="text-lg font-medium mb-2">Cookies or Browser Cookies</h4>
          <p className="mb-2">
        ...
        <div className="mb-4">
          <h4 className="text-lg font-medium mb-2">Web Beacons</h4>
          <p>
        ...
        <h4 className="text-lg font-medium mb-2">We use both Session and Persistent Cookies for the purposes set out below:</h4>
        
        <div className="mb-4">
          <h5 className="font-medium">Necessary / Essential Cookies</h5>
        ...
        <div className="mb-4">
          <h5 className="font-medium">Cookies Policy / Notice Acceptance Cookies</h5>
        ...
        <div className="mb-4">
          <h5 className="font-medium">Functionality Cookies</h5>
          <p><strong>Type:</strong> Persistent Cookies</p>
          <p><strong>Administered by:</strong> Us</p>
      ...
      <section className="mb-8">
        ...
        <h3 className="text-xl font-medium mb-2">We may share Your personal information in the following situations:</h3>
